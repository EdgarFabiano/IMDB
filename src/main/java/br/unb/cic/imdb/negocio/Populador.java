...
public class Populador {	
	...
	public Populador() {}
	/**
	 * RETIRAR SECOES COMENTADAS PARA UTILIZAR IMPLEMENTACAO EM MEMORIA
	 * 
...
//		usuario3.setId((long) 3);
		...
		Autor autor1 = new Autor("Wesley Safadao", "Famoso recentemente");
//		autor1.setId((long) 1);
		facade.adicionaAutor(autor1);
		Autor autor2 = new Autor("George Lucas", "Famoso por dirigir a saga Star Wars");
//		autor2.setId((long) 2);
		facade.adicionaAutor(autor2);
		Autor autor3 = new Autor("Peter Jackson", "Famoso por dirigir a trilogia Senhor dos Aneis");
//		autor3.setId((long) 3);
		facade.adicionaAutor(autor3);
		Autor autor4 = new Autor("Iron Maiden", "Banda de heavy metal britânica");
//		autor4.setId((long) 4);
		facade.adicionaAutor(autor4);
		
		Genero genero1 = new Genero("Ficcao Cientifica", "Ficcao com base em teorias cientificas");
//		genero1.setId((long) 1);
		facade.adicionaGenero(genero1);
		Genero genero2 = new Genero("Aventura", "Aventuras fantasiosas");
//		genero2.setId((long) 2);
		facade.adicionaGenero(genero2);
		Genero genero3 = new Genero("Rock", "Ok ... bem melhor");
